...
npm.cmd test
npm.cmd run build
node --test --test-concurrency=1 test/integration/release-artifact.test.ts
...
Keep agent plans, local client state, model-evaluation traces, and evaluation
result summaries outside the public repository.
